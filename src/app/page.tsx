...
//       <Header ctaTitle="analyzeMyResume" ctaLink="/upload-cv" />
...
export default function HomePage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-background text-2xl font-semibold text-primary">
      Hello, landing page
    </div>
  );
}