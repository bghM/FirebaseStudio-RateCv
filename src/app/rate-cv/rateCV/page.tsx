...
const textContent = new TextDecoder().decode(arrayBuffer); // naive fallback
const mcp = useMCP('rate-cv', 'analyze CV for improvements', { text: textContent });
...
if (!response.ok) {
  toast({ title: 'Error', description: 'Failed to analyze the CV.', variant: 'destructive' });
} else {
  const result = await response.text();
  toast({ title: 'Analysis Result', description: result });
}
setLoading(false);
...
return (
<> <Head> <title>{t.rateCV.heroTitle}</title> <meta name="description" content={t.rateCV.heroSubtitle} /> <meta name="robots" content="index, follow" /> <meta property="og:title" content={t.rateCV.heroTitle} /> <meta property="og:description" content={t.rateCV.heroSubtitle} /> <meta property="og:type" content="website" />
<meta property="og:locale" content={language === 'ar' ? 'ar_SA' : 'en_US'} /> <meta name="twitter:card" content="summary_large_image" /> <meta name="twitter:title" content={t.rateCV.heroTitle} /> <meta name="twitter:description" content={t.rateCV.heroSubtitle} />
<meta name="language" content={language === 'ar' ? 'Arabic' : 'English'} /> </Head>
